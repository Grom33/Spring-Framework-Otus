...
public class TestingServiceImplTest extends AbstractServiceTest {
    ...
    public void getBatchTestQuestions() {
       Set<TestQuestion> setQuestion = testingService.getBatchTestQuestions(TestData.TES_COUNT, lang.toString());
       Assert.assertEquals(setQuestion.size(),TestData.TES_COUNT);

       Set<TestQuestion> secondQuestion = testingService.getBatchTestQuestions(TestData.TES_COUNT, lang.toString());
