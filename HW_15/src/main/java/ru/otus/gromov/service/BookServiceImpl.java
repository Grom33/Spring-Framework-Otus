...
public class BookServiceImpl implements BookService {
	...
	private final PollableChannel recieveChannel;
	//private final DirectChannel sendChannel;


	public BookServiceImpl(BookRepository repository, CommentRepository commentRepository, PollableChannel recieveChannel) {
	...
	private void messageResolver(Message message) {
