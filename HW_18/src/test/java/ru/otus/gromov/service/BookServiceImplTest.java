...
public class BookServiceImplTest extends AbstractServiceTest {
    ...
    public void insert() {
        Book bookExpectedEdited = new Book(0L, "Effective java 3rd edition",
                ...
                new ArrayList<>());
        service.insert(bookExpectedEdited);
        Assert.assertEquals(bookExpectedEdited.getId(), service.getByName(bookExpectedEdited.getName()).getId());
    }
